 ...
 *
 * @brief             - Function for configure priority for IRQ
 *
 * @param[in]         - IRQ number
 * @param[in]         - Specific IRQ priority
 */
 ...
 * @fn      		  - USART_IRQHandler
 *
 * @brief             - Function for handling IRQ
 *
 * @param[in]         - Structure with configuration specific USART
 */
